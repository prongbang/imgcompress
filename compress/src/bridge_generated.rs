...
fn wire_compress_mozjpeg_impl(
    port_: MessagePort,
    image: impl Wire2Api<Vec<u8>> + UnwindSafe,
    width: impl Wire2Api<usize> + UnwindSafe,
    height: impl Wire2Api<usize> + UnwindSafe,
    quality: impl Wire2Api<f32> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        WrapInfo {
            debug_name: "compress_mozjpeg",
            port: Some(port_),
